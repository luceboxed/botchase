function HUD()
    ...
    if client:GetObserverMode() >= 1 then
        ...
        draw.SimpleText("Speed: "..math.floor(math.abs(spectatetarget:GetVelocity()[1] + spectatetarget:GetVelocity()[2])), "DermaDefaultBold", 10, ScrH() - 50, Color(255, 255, 255, 255), 0, 0)
        ...
        draw.SimpleText("Speed: "..math.floor(math.abs(client:GetVelocity()[1] + client:GetVelocity()[2])), "DermaDefaultBold", 10, ScrH() - 50, Color(255, 255, 255, 255), 0, 0)
